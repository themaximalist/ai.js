const log = require("debug")("ai.js:llm:index");
...
function LLM(input, options = null) {
    ...
    this.model = options.model || process.env.AI_MODEL || services[this.service].defaultModel;
...
LLM.prototype.send = async function (options = null) {
